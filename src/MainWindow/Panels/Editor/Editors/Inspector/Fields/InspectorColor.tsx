...
function InspectorColor(props: FieldProps) {
    ...
    return <Row className="gx-1">
        <Col>
            <Form.Control type={"number"} value={r} onChange={(e) => onUpdate(e.target.value, "r")}/>
        </Col>
        <Col>
            <Form.Control type={"number"} value={g} onChange={(e) => onUpdate(e.target.value, "g")}/>
        </Col>
        <Col>
            <Form.Control type={"number"} value={b} onChange={(e) => onUpdate(e.target.value, "b")}/>
        </Col>
        <Col>
            <Form.Control type={"number"} value={a} onChange={(e) => onUpdate(e.target.value, "a")}/>
        </Col>
    </Row>;
}
